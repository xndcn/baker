...
from .definitions.cc.cc_library import CCLibrary
from .definitions.cc.cc_test_library import CCTestLibrary
from .definitions.cc.cc_library_headers import CCLibraryHeaders
from .definitions.defaults import Defaults
from .definitions.cc.cc_binary import CCBinary
from .definitions.cc.cc_test import CCTest
from .definitions.cc.cc_object import CCObject
