...
class CCLibrary(Module):
    ...
    def convert_to_cmake(self):
        ...
        return self._convert_module_to_cmake(function, object)
...
class CCLibraryHeaders(Module):
    ...
    def convert_to_cmake(self):
        return self._convert_module_to_cmake("baker_cc_library_headers", None, "INTERFACE")
...
class CCTestLibrary(Module):
    ...
    def convert_to_cmake(self):
        name = self._get_property("name")
        object = Utils.to_internal_name(name, "OBJ")
        return self._convert_module_to_cmake("baker_cc_test_library", object)