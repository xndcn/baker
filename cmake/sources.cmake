...
function(baker_get_sources out_var target)
    ...
    if(ARGS_SCOPE STREQUAL "PRIVATE")
        get_target_property(sources ${target} _PRIVATE_SOURCES_)
    elseif(ARGS_SCOPE STREQUAL "INTERFACE")
        get_target_property(sources ${target} _INTERFACE_SOURCES_)
    endif()
    ...
    # Return the result
    set(${out_var} ${sources} PARENT_SCOPE)
    set_property(TARGET ${target} APPEND PROPERTY _${ARGS_SCOPE}_SOURCES_ ${sources})
