...
${metalava} \
    ...
    $<JOIN:$<GENEX_EVAL:$<GENEX_EVAL:$<GENEX_EVAL:$<TARGET_PROPERTY:_droiddoc_options>>>>, > \
    $<JOIN:$<GENEX_EVAL:$<GENEX_EVAL:$<GENEX_EVAL:$<TARGET_PROPERTY:_args>>>>, > \
    $<JOIN:$<GENEX_EVAL:$<GENEX_EVAL:$<GENEX_EVAL:$<TARGET_PROPERTY:_flags>>>>, > \
