...
include(${CMAKE_CURRENT_LIST_DIR}/hidl.cmake)
...
function(baker_parse_metadata)
    ...
    if(NOT namespace STREQUAL "")
        set(name "${namespace}+${ARG_name}")
    endif()
    baker_canonicalize_name(name "${name}")
    ...
    return(PROPAGATE name ARG_name ARG_srcs ${arg_ALL_SINGLE_KEYS} ${arg_ALL_LIST_KEYS} ARG__ALL_SINGLE_KEYS_ ARG__ALL_LIST_KEYS_ ARG__ALL_EVAL_KEYS_ ARG_UNPARSED_ARGUMENTS)
endfunction()
